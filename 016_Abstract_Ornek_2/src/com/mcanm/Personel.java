...
// Sınıfımız eğer aşağıdaki gibi olsaydı bu sınıftan IdariMemur, Muhendis, Sekreter vb. gibi sınıflar extend edemezdi:
// public final class Personel {

public abstract class Personel {
	
	public static final int dunyaninYaricapi = 40000;
