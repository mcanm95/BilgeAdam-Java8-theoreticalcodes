...
public class VeriTipleriTamSayilar {
	...
	public static void main(String[] args) {
		...
		// longValue = 9223372036854775807; // bu aslında long'un alabileceği bir değer ama integer'ın alabileceği değerlerden yüksek 
		...
		System.out.println("carpım :" + carpim); // Yanlış sonuç verir. Neden? Sağ taraftaki int sorunu burda da yaşandı
		//çözüm:
